...
class Regr3D_dust3r (Criterion, MultiLoss):
...
class Regr3D (Regr3D_dust3r):
    ...
    def get_all_pts3d(self, gt1, gt2, pred1, pred2, dist_clip=None):
        ...
        sky1 = gt1['sky_mask'].to(valid1.device) & (~valid1)
        sky2 = gt2['sky_mask'].to(valid2.device) & (~valid2)
...
class Regr3D_ShiftInv (Regr3D_dust3r):
    """ Same than Regr3D_dust3r but invariant to depth shift.
    """
...
class Regr3D_ScaleInv (Regr3D_dust3r):
    """ Same than Regr3D_dust3r but invariant to depth shift.
