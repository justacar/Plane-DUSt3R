...
from dust3r.model import AsymmetricCroCo3DStereo, inf, AsymmetricCroCo3DStereoTuning,AsymmetricCroCo3DStereoTuning2  # noqa: F401, needed when loading the model
...
def get_args_parser():
    ...
    # others
    parser.add_argument('--nodist', default=True, type=bool)
